...
Сравнение скорости на одной картинке (`model.predict`, CPU, 30 прогонов):

| | RGB (3 канала) | grey (1 канал) |
|---|---|---|
| FPS | 3.57 | **6.84** |
| Время на картинку | 280 мс | **146 мс** |

**Вывод: grey (1 канал) быстрее (~1.9×)** — за счёт меньшего объёма данных
(ч/б = 1 канал вместо 3).
