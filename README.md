...
Это **отдельный замер** (другой метод/число ядер), поэтому абсолютные числа отличаются от
главной таблицы выше — важно **соотношение** 1 канал / 3 канала внутри этого замера:
